$(document).ready(function() {
	$.Juitter.start({
		...
		searchObject:"goldfishlive", // needed, you can insert a username here or a word to be searched for, if you wish multiple search, separate the words by comma.
	...
	$("#goldfishlive").click(function(){
		$(".jLinks").removeClass("on");
		$(this).addClass("on");									  
		$.Juitter.start({
			searchType:"fromUser",
			searchObject:"goldfishlive",
